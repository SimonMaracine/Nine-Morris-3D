...
colors[ImGuiCol_FrameBg]                = ImVec4(0.41f, 0.41f, 0.41f, 0.39f);
...
colors[ImGuiCol_TitleBg]                = ImVec4(0.52f, 0.52f, 0.52f, 0.83f);
colors[ImGuiCol_TitleBgActive]          = ImVec4(0.50f, 0.50f, 0.50f, 0.87f);
colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.76f, 0.76f, 0.76f, 0.20f);
colors[ImGuiCol_MenuBarBg]              = ImVec4(0.51f, 0.51f, 0.51f, 0.80f);
colors[ImGuiCol_ScrollbarBg]            = ImVec4(0.30f, 0.30f, 0.30f, 0.60f);
...
colors[ImGuiCol_Tab]                    = ImVec4(0.58f, 0.58f, 0.58f, 0.79f);
colors[ImGuiCol_TabSelected]            = ImVec4(0.72f, 0.72f, 0.72f, 0.84f);
colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.86f, 0.86f, 0.86f, 0.80f);
colors[ImGuiCol_TabDimmed]              = ImVec4(0.56f, 0.56f, 0.56f, 0.82f);
colors[ImGuiCol_TabDimmedSelected]      = ImVec4(0.65f, 0.65f, 0.65f, 0.84f);
colors[ImGuiCol_TabDimmedSelectedOverline]  = ImVec4(0.88f, 0.88f, 0.88f, 0.00f);
colors[ImGuiCol_PlotLines]              = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
colors[ImGuiCol_PlotHistogram]          = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.38f, 0.38f, 0.38f, 1.00f);
colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.45f, 0.45f, 0.45f, 1.00f);
colors[ImGuiCol_TableBorderLight]       = ImVec4(0.26f, 0.26f, 0.28f, 1.00f);
colors[ImGuiCol_TableRowBg]             = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
colors[ImGuiCol_TableRowBgAlt]          = ImVec4(1.00f, 1.00f, 1.00f, 0.07f);
colors[ImGuiCol_TextLink]               = ImVec4(0.63f, 0.63f, 0.88f, 0.80f);
colors[ImGuiCol_TextSelectedBg]         = ImVec4(0.00f, 0.00f, 1.00f, 0.35f);
colors[ImGuiCol_DragDropTarget]         = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
colors[ImGuiCol_NavCursor]              = ImVec4(0.80f, 0.80f, 0.89f, 0.80f);
...
void Ui::set_style() {
    ...
    style.Colors[ImGuiCol_Text]                   = ImVec4(0.821f, 0.82f, 0.82f, 1.00f);
    style.Colors[ImGuiCol_TextDisabled]           = ImVec4(0.601f, 0.60f, 0.60f, 1.00f);
    style.Colors[ImGuiCol_WindowBg]               = ImVec4(0.00f, 0.00f, 0.00f, 0.85f);
    style.Colors[ImGuiCol_ChildBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_PopupBg]                = ImVec4(0.111f, 0.11f, 0.14f, 0.92f);
    style.Colors[ImGuiCol_Border]                 = ImVec4(0.451f, 0.45f, 0.45f, 0.50f);
    style.Colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_FrameBg]                = ImVec4(0.411f, 0.41f, 0.41f, 0.39f);
    style.Colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.681f, 0.68f, 0.68f, 0.40f);
    style.Colors[ImGuiCol_FrameBgActive]          = ImVec4(0.641f, 0.64f, 0.64f, 0.69f);
    style.Colors[ImGuiCol_TitleBg]                = ImVec4(0.521f, 0.52f, 0.52f, 0.83f);
    style.Colors[ImGuiCol_TitleBgActive]          = ImVec4(0.501f, 0.50f, 0.50f, 0.87f);
    style.Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.761f, 0.76f, 0.76f, 0.20f);
    style.Colors[ImGuiCol_MenuBarBg]              = ImVec4(0.511f, 0.51f, 0.51f, 0.80f);
    style.Colors[ImGuiCol_ScrollbarBg]            = ImVec4(0.301f, 0.30f, 0.30f, 0.60f);
    style.Colors[ImGuiCol_ScrollbarGrab]          = ImVec4(0.811f, 0.81f, 0.81f, 0.30f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.831f, 0.83f, 0.83f, 0.40f);
    style.Colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.801f, 0.80f, 0.80f, 0.60f);
    style.Colors[ImGuiCol_CheckMark]              = ImVec4(0.901f, 0.90f, 0.90f, 0.50f);
    style.Colors[ImGuiCol_SliderGrab]             = ImVec4(1.00f, 1.00f, 1.00f, 0.30f);
    style.Colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.801f, 0.80f, 0.80f, 0.60f);
    style.Colors[ImGuiCol_Button]                 = ImVec4(0.621f, 0.62f, 0.62f, 0.62f);
    style.Colors[ImGuiCol_ButtonHovered]          = ImVec4(0.711f, 0.71f, 0.71f, 0.79f);
    style.Colors[ImGuiCol_ButtonActive]           = ImVec4(0.811f, 0.81f, 0.81f, 1.00f);
    style.Colors[ImGuiCol_Header]                 = ImVec4(0.621f, 0.62f, 0.62f, 0.45f);
    style.Colors[ImGuiCol_HeaderHovered]          = ImVec4(0.561f, 0.56f, 0.56f, 0.80f);
    style.Colors[ImGuiCol_HeaderActive]           = ImVec4(0.701f, 0.70f, 0.70f, 0.80f);
    style.Colors[ImGuiCol_Separator]              = ImVec4(0.501f, 0.50f, 0.50f, 0.60f);
    style.Colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.701f, 0.70f, 0.70f, 1.00f);
    style.Colors[ImGuiCol_SeparatorActive]        = ImVec4(0.901f, 0.90f, 0.90f, 1.00f);
    style.Colors[ImGuiCol_ResizeGrip]             = ImVec4(1.00f, 1.00f, 1.00f, 0.10f);
    style.Colors[ImGuiCol_ResizeGripHovered]      = ImVec4(1.00f, 1.00f, 1.00f, 0.60f);
    style.Colors[ImGuiCol_ResizeGripActive]       = ImVec4(1.00f, 1.00f, 1.00f, 0.90f);
    style.Colors[ImGuiCol_TabHovered]             = ImVec4(0.751f, 0.75f, 0.75f, 0.80f);
    style.Colors[ImGuiCol_Tab]                    = ImVec4(0.581f, 0.58f, 0.58f, 0.79f);
    style.Colors[ImGuiCol_TabSelected]            = ImVec4(0.721f, 0.72f, 0.72f, 0.84f);
    style.Colors[ImGuiCol_TabSelectedOverline]    = ImVec4(0.861f, 0.86f, 0.86f, 0.80f);
    style.Colors[ImGuiCol_TabDimmed]              = ImVec4(0.561f, 0.56f, 0.56f, 0.82f);
    style.Colors[ImGuiCol_TabDimmedSelected]      = ImVec4(0.651f, 0.65f, 0.65f, 0.84f);
    style.Colors[ImGuiCol_TabDimmedSelectedOverline]  = ImVec4(0.881f, 0.88f, 0.88f, 0.00f);
    style.Colors[ImGuiCol_PlotLines]              = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    style.Colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.901f, 0.70f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogram]          = ImVec4(0.901f, 0.70f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.381f, 0.38f, 0.38f, 1.00f);
    style.Colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.451f, 0.45f, 0.45f, 1.00f);
    style.Colors[ImGuiCol_TableBorderLight]       = ImVec4(0.261f, 0.26f, 0.28f, 1.00f);
    style.Colors[ImGuiCol_TableRowBg]             = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_TableRowBgAlt]          = ImVec4(1.00f, 1.00f, 1.00f, 0.07f);
    style.Colors[ImGuiCol_TextLink]               = ImVec4(0.631f, 0.63f, 0.88f, 0.80f);
    style.Colors[ImGuiCol_TextSelectedBg]         = ImVec4(0.00f, 0.00f, 1.00f, 0.35f);
    style.Colors[ImGuiCol_DragDropTarget]         = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
    style.Colors[ImGuiCol_NavCursor]              = ImVec4(0.80f, 0.80f, 0.89f, 0.80f);
