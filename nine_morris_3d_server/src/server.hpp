...
private:
    ...
    void client_timeout(std::shared_ptr<networking::ClientConnection> connection, const networking::Message& message);
    void server_remote_timed_out(std::shared_ptr<networking::ClientConnection> connection);
