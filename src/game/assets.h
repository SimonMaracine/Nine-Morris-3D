...
namespace assets {
    extern const char* BOARD_WOOD_MESH;
    ...
    extern const char* BOARD_WOOD_DIFFUSE_TEXTURE;
    extern const char* BOARD_PAINT_DIFFUSE_TEXTURE;
    extern const char* LABELED_BOARD_PAINT_DIFFUSE_TEXTURE;
    extern const char* BOARD_NORMAL_TEXTURE;
    extern const char* PIECE_NORMAL_TEXTURE;
    extern const char* WHITE_PIECE_DIFFUSE_TEXTURE;
    extern const char* BLACK_PIECE_DIFFUSE_TEXTURE;

    extern const char* BOARD_WOOD_DIFFUSE_TEXTURE_SMALL;
    extern const char* BOARD_PAINT_DIFFUSE_TEXTURE_SMALL;
    extern const char* LABELED_BOARD_PAINT_DIFFUSE_TEXTURE_SMALL;
    extern const char* BOARD_NORMAL_TEXTURE_SMALL;
    extern const char* PIECE_NORMAL_TEXTURE_SMALL;
    extern const char* WHITE_PIECE_DIFFUSE_TEXTURE_SMALL;
    extern const char* BLACK_PIECE_DIFFUSE_TEXTURE_SMALL;
    ...
    extern const char* PIECE_PLACE_SOUND1;
