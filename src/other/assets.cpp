...
namespace assets {
    ...
    const char* BOARD_WOOD_TEXTURE = "data/textures/board/board_wood.png";
    ...
    const char* BOARD_WOOD_TEXTURE_SMALL = "data/textures/board/board_wood-small.png";
    ...
    const char* BLACK_PIECE_TEXTURE_SMALL = "data/textures/piece/black_piece-small.png";
    ...
    const char* FIELD_PY_TEXTURE = "data/textures/skybox/field/py.png";
    const char* FIELD_NY_TEXTURE = "data/textures/skybox/field/ny.png";
    const char* FIELD_PZ_TEXTURE = "data/textures/skybox/field/pz.png";
    const char* FIELD_NZ_TEXTURE = "data/textures/skybox/field/nz.png";
    const char* FIELD_PX_TEXTURE_SMALL = "data/textures/skybox/field/px-small.png";
    const char* FIELD_NX_TEXTURE_SMALL = "data/textures/skybox/field/nx-small.png";
    const char* FIELD_PY_TEXTURE_SMALL = "data/textures/skybox/field/py-small.png";
    const char* FIELD_NY_TEXTURE_SMALL = "data/textures/skybox/field/ny-small.png";
    const char* FIELD_PZ_TEXTURE_SMALL = "data/textures/skybox/field/pz-small.png";
    const char* FIELD_NZ_TEXTURE_SMALL = "data/textures/skybox/field/nz-small.png";
    const char* AUTUMN_PX_TEXTURE = "data/textures/skybox/autumn/px.png";
    const char* AUTUMN_NX_TEXTURE = "data/textures/skybox/autumn/nx.png";
    const char* AUTUMN_PY_TEXTURE = "data/textures/skybox/autumn/py.png";
    const char* AUTUMN_NY_TEXTURE = "data/textures/skybox/autumn/ny.png";
    const char* AUTUMN_PZ_TEXTURE = "data/textures/skybox/autumn/pz.png";
    const char* AUTUMN_NZ_TEXTURE = "data/textures/skybox/autumn/nz.png";
    const char* AUTUMN_PX_TEXTURE_SMALL = "data/textures/skybox/autumn/px-small.png";
    const char* AUTUMN_NX_TEXTURE_SMALL = "data/textures/skybox/autumn/nx-small.png";
    const char* AUTUMN_PY_TEXTURE_SMALL = "data/textures/skybox/autumn/py-small.png";
    const char* AUTUMN_NY_TEXTURE_SMALL = "data/textures/skybox/autumn/ny-small.png";
    const char* AUTUMN_PZ_TEXTURE_SMALL = "data/textures/skybox/autumn/pz-small.png";
    const char* AUTUMN_NZ_TEXTURE_SMALL = "data/textures/skybox/autumn/nz-small.png";
