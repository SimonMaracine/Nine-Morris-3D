...
namespace assets {
    ...
    const char* BOARD_TEXTURE_SMALL = "data/textures/board/board_wood-small.png";
    ...
    const char* SKYBOX_PX_TEXTURE = "data/textures/skybox/field/px.png";  // TODO also provide small variants to these maybe
