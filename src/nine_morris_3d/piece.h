...
public:
    ...
    // glm::vec3 parabolic_target = glm::vec3(0.0f);
    // bool reached_parabolic_target = false;
    float curve_position = 0.0f;  // Between 0 and pi
    glm::vec3 fake_position = glm::vec3(0.0f);
    glm::vec3 fake_velocity = glm::vec3(0.0f);
