...
namespace assets_load {
    struct AllStartLoader : sm::ConcurrentLoader<AllStartLoader, bool, int, bool, int> {
    ...
    struct SkyboxLoader : sm::ConcurrentLoader<SkyboxLoader, int, int> {
    ...
    struct BoardPaintTextureLoader : sm::ConcurrentLoader<BoardPaintTextureLoader, int, bool> {
