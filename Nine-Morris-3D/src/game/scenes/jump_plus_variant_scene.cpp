...
void JumpPlusVariantScene::on_start() {
    ...
    app->evt.connect<MouseButtonPressedEvent, &JumpPlusVariantScene::on_mouse_button_pressed>(this);
    app->evt.connect<MouseButtonReleasedEvent, &JumpPlusVariantScene::on_mouse_button_released>(this);
    app->evt.connect<KeyPressedEvent, &JumpPlusVariantScene::on_key_pressed>(this);
    app->evt.connect<KeyReleasedEvent, &JumpPlusVariantScene::on_key_released>(this);
    app->evt.connect<WindowResizedEvent, &JumpPlusVariantScene::on_window_resized>(this);
}
