...
//         storage.projection_uniform_buffer = std::make_shared<GlUniformBuffer>();
...
//         auto index_buffer = std::make_shared<GlIndexBuffer>(buffer, sizeof(unsigned int) * MAX_INDICES);
