...
//         SM_ASSERT(samples > 0, "Samples must be greater than 0");
...
//         SM_ASSERT(size > 0, "Shadow map size must be greater than 0");
...
//         storage.skybox_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(SKYBOX_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(SKYBOX_FRAGMENT_SHADER)),
...
//         storage.screen_quad_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(SCREEN_QUAD_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(SCREEN_QUAD_FRAGMENT_SHADER)),
...
//         storage.quad3d_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(QUAD3D_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(QUAD3D_FRAGMENT_SHADER)),
//             std::vector<std::string> {
//                 "u_model_matrix",
//                 "u_view_matrix",
//                 "u_projection_matrix",
...
//         storage.shadow_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(SHADOW_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(SHADOW_FRAGMENT_SHADER)),
...
//         storage.outline_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(OUTLINE_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(OUTLINE_FRAGMENT_SHADER)),
//             std::vector<std::string> {
//                 "u_model_matrix",
//                 "u_color"
//             },
...
//         storage.box_shader = std::make_shared<gl::GlShader>(
//             Encrypt::encr(FileSystem::path_for_assets(BOUNDING_BOX_VERTEX_SHADER)),
//             Encrypt::encr(FileSystem::path_for_assets(BOUNDING_BOX_FRAGMENT_SHADER)),
//             std::vector<std::string> {},
//             std::initializer_list { storage.projection_view_uniform_block }
//         );
...
//             storage.origin_shader = std::make_shared<gl::GlShader>(
//                 FileSystem::path_for_assets(ORIGIN_VERTEX_SHADER),
//                 FileSystem::path_for_assets(ORIGIN_FRAGMENT_SHADER),
